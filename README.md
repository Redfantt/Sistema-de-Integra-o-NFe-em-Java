# Java-NFe [![MIT License](https://img.shields.io/github/license/Luiz-Carvalho/Java_NFe.svg) ](https://github.com/Luiz-Carvalho/Java_NFe/blob/master/LICENSE) [![Maven Central](https://img.shields.io/maven-central/v/br.com.swconsultoria/java-nfe.svg?label=Maven%20Central)](https://search.maven.org/artifact/br.com.swconsultoria/java-nfe/4.00.51/jar) [![Coverage Status](https://coveralls.io/repos/github/Luiz-Carvalho/Java_NFe/badge.svg?branch=master)](https://coveralls.io/github/Luiz-Carvalho/Java_NFe?branch=master)
...
Para Iniciar : 
- Baixe o Schemas.rar (https://github.com/Luiz-Carvalho/Java_NFe/raw/master/schemas.zip) e extraia na sua Máquina.

- External Jar: Baixe e adicione às bibliotecas de seu Projeto.
  - https://github.com/Luiz-Carvalho/Java_NFe/releases
...
Veja a Wiki https://github.com/Luiz-Carvalho/Java_NFe/wiki, para ter um Tutorial Completo.
...
- Adicionado novos eventos da reforma Tributaria (Ver exemplo em: https://github.com/Luiz-Carvalho/Java_NFe/blob/master/src/test/java/br/com/swconsultoria/nfe/exemplos/EventoGenericoTeste.java)
- Adicionado ao projeto o calculo e preenchimento automatico do IBSCBS dos Itens e do Total (Ver exemplo em: https://github.com/Luiz-Carvalho/Java_NFe/blob/master/src/test/java/br/com/swconsultoria/nfe/exemplos/CalculosIbsCbsTeste.java)

## v4.00.45 - 09/11/2025 - Schemas PL.010b (v1.1)
- Adicionado Conculta ao JSON dos CST/Cclasstrib do IBSCBS (Ver exemplo em: https://github.com/Luiz-Carvalho/Java_NFe/blob/master/src/test/java/br/com/swconsultoria/nfe/exemplos/ConsultaTributacaoTeste.java)
...
- Adicionado Impressao de NFe, NFCe e CCe : https://github.com/Luiz-Carvalho/Java_NFe/wiki/14-:-Impressao
...
- Atualizado Java Certificado (Ver https://github.com/Luiz-Carvalho/Java_Certificado)
...
## v4.00.10 - 20/03/2019
   **Guia de Migração: https://gist.github.com/Luiz-Carvalho/c547decad469f21ff99de1c766bdc75d**
...
** Leia para mais informações https://gist.github.com/Luiz-Carvalho/72f88a91c72465e038dbecd065fe1e12 ** 
